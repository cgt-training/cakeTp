...
class EnquiriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'query' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'email' => 'a8301893-2d5b-468d-b702-22cc02329f0e',
